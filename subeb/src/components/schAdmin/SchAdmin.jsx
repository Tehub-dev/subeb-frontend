...
const SchAdmin = ({adminData}) => {
  ...
  const clickEdit = () => {
    ...
    const CustomCell = ({ row }) => (
      <div style={{display: "flex", gap: "30px", alignItems: "center"}}>
        <Trash style={{color: "red", cursor: "pointer"}} onClick={() => deleteAdmin(row)} />
  ...
  return (
    <div className="sch-admin">
        ...
        <DeletePopup title={"Remove School Admin"} text={"Are you sure you want to remove this School Admin?"} display={adminDelete} cancelBtn={cancelAdd} />
        <UpdatePopup display={adminEdit} cancelBtn={cancelEdit} title={"Update School Admin"} text={"Are you sure you want to update this School Admin?"} updateBtn={clickEdit} />
      ...
      <div className="admin-body">
        <div className="admin-body_head">
            <h3>School Admins <span>100</span></h3>
        </div>
